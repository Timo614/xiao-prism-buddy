...
void screen_cryptocurrency_init(void) {
    ...
    lv_img_set_src(screen_cryptocurrency_image, &ui_coins_btc);
    lv_img_set_src(screen_cryptocurrency_image, &ui_coins_doge);
    lv_img_set_src(screen_cryptocurrency_image, &ui_coins_eth);
    lv_img_set_src(screen_cryptocurrency_image, &ui_coins_xrp);
